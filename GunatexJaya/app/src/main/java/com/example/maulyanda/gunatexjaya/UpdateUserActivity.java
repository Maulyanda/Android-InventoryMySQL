...
public class UpdateUserActivity extends ActionBarActivity {
    ...
    private void getUser(){
        class GetUser extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("http://192.168.100.14/tb-android/get_user.php?id=",id);
                return s;
            }
        }
    ...
    private void updateUser(){
        ...
        class UpdateUser extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("http://192.168.100.14/tb-android/update_user.php", hashMap);
    ...
    private void deleteUser(){
        class DeleteUser extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("http://192.168.100.14/tb-android/delete_user.php?id=", id);
                return s;
            }
        }
