package com.example.maulyanda.gunatexjaya;
...
public class UpdateDistributorActivity extends ActionBarActivity {
    ...
    private void getDistibutor(){
        class GetDistributor extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("http://192.168.100.14/tb-android/get_distributor.php?id=",id);
                return s;
            }
        }
    ...
    private void updateDistributor(){
        ...
        class UpdateDistributor extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("http://192.168.100.14/tb-android/update_distributor.php", hashMap);
    ...
    private void deleteDistributor(){
        class DeleteDistributor extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("http://192.168.100.14/tb-android/delete_distributor.php?id=", id);
                return s;
            }
        }
