...
public class UpdateProductActivity extends ActionBarActivity {
    ...
    private void getProduct(){
        class GetProduct extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("http://192.168.100.14/tb-android/get_product.php?id=",id);
                return s;
            }
        }
    ...
    private void updateProduct(){
        ...
        class UpdateProduct extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("http://192.168.100.14/tb-android/update_product.php", hashMap);
    ...
    private void deleteProduct(){
        class DeleteProduct extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("http://192.168.100.14/tb-android/delete_product.php?id=", id);
                return s;
            }
        }
